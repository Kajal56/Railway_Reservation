...
GRANT ALL ON classseats TO admin; 
-- ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
-- DROP TRIGGER IF EXISTS before_insert_on_account;
-- DELIMITER //
-- CREATE TRIGGER before_insert_on_account BEFORE INSERT ON account
--  FOR EACH ROW begin
...
-- //
-- DELIMITER ;
-- DROP TRIGGER IF EXISTS before_update_on_account;
-- DELIMITER //
-- CREATE TRIGGER before_update_on_account BEFORE UPDATE ON account
--  FOR EACH ROW begin
-- if (year(curdate())-year(new.dob))<18 then 
-- SIGNAL SQLSTATE '45000'
-- SET MESSAGE_TEXT = 'Minimum age bar of 18 years.';
